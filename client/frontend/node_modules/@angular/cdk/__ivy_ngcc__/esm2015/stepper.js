...
CdkStepLabel.ngFactoryDef = function CdkStepLabel_Factory(t) { return new (t || CdkStepLabel)(ɵngcc0.ɵɵdirectiveInject(TemplateRef)); };
CdkStepLabel.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkStepLabel, selectors: [["", "cdkStepLabel", ""]] });
...
CdkStepHeader.ngFactoryDef = function CdkStepHeader_Factory(t) { return new (t || CdkStepHeader)(ɵngcc0.ɵɵdirectiveInject(ElementRef)); };
CdkStepHeader.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkStepHeader, selectors: [["", "cdkStepHeader", ""]], hostBindings: function CdkStepHeader_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
CdkStep.ngFactoryDef = function CdkStep_Factory(t) { return new (t || CdkStep)(ɵngcc0.ɵɵdirectiveInject(forwardRef(( /**
                 * @return {?}
                 */() => CdkStepper))), ɵngcc0.ɵɵdirectiveInject(STEPPER_GLOBAL_OPTIONS, 8)); };
CdkStep.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: CdkStep, selectors: [["cdk-step"]], contentQueries: function CdkStep_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkStep, [{
        ...
        args: [{ selector: 'cdk-step',
            ...
            }] }]; }, { constructor: [], _stepper: [], interacted: [], _editable: [], _optional: [], _customCompleted: [], _customError: [], _stepperOptions: [], _displayDefaultIndicatorType: [], _showError: [], editable: [{
            type: Input
        }], editable: [], optional: [{
            type: Input
        }], optional: [], completed: [{
...
CdkStepper.ngFactoryDef = function CdkStepper_Factory(t) { return new (t || CdkStepper)(ɵngcc0.ɵɵdirectiveInject(Directionality, 8), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(DOCUMENT)); };
CdkStepper.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkStepper, selectors: [["", "cdkStepper", ""]], contentQueries: function CdkStepper_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
...
CdkStepperNext.ngFactoryDef = function CdkStepperNext_Factory(t) { return new (t || CdkStepperNext)(ɵngcc0.ɵɵdirectiveInject(CdkStepper)); };
CdkStepperNext.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkStepperNext, selectors: [["button", "cdkStepperNext", ""]], hostBindings: function CdkStepperNext_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
CdkStepperPrevious.ngFactoryDef = function CdkStepperPrevious_Factory(t) { return new (t || CdkStepperPrevious)(ɵngcc0.ɵɵdirectiveInject(CdkStepper)); };
CdkStepperPrevious.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkStepperPrevious, selectors: [["button", "cdkStepperPrevious", ""]], hostBindings: function CdkStepperPrevious_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵallocHostVars(1);
