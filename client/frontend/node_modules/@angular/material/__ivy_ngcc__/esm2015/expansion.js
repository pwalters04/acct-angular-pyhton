...
MatExpansionPanelContent.ngFactoryDef = function MatExpansionPanelContent_Factory(t) { return new (t || MatExpansionPanelContent)(ɵngcc0.ɵɵdirectiveInject(TemplateRef)); };
MatExpansionPanelContent.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatExpansionPanelContent, selectors: [["ng-template", "matExpansionPanelContent", ""]] });
...
MatExpansionPanelActionRow.ngFactoryDef = function MatExpansionPanelActionRow_Factory(t) { return new (t || MatExpansionPanelActionRow)(); };
MatExpansionPanelActionRow.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatExpansionPanelActionRow, selectors: [["mat-action-row"]], hostBindings: function MatExpansionPanelActionRow_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
MatExpansionPanelHeader.ngFactoryDef = function MatExpansionPanelHeader_Factory(t) { return new (t || MatExpansionPanelHeader)(ɵngcc0.ɵɵdirectiveInject(MatExpansionPanel, 1), ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(FocusMonitor), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(MAT_EXPANSION_PANEL_DEFAULT_OPTIONS, 8)); };
MatExpansionPanelHeader.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: MatExpansionPanelHeader, selectors: [["mat-expansion-panel-header"]], hostBindings: function MatExpansionPanelHeader_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
MatExpansionPanelDescription.ngFactoryDef = function MatExpansionPanelDescription_Factory(t) { return new (t || MatExpansionPanelDescription)(); };
MatExpansionPanelDescription.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatExpansionPanelDescription, selectors: [["mat-panel-description"]], hostBindings: function MatExpansionPanelDescription_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
MatExpansionPanelTitle.ngFactoryDef = function MatExpansionPanelTitle_Factory(t) { return new (t || MatExpansionPanelTitle)(); };
MatExpansionPanelTitle.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatExpansionPanelTitle, selectors: [["mat-panel-title"]], hostBindings: function MatExpansionPanelTitle_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
MatAccordion.ngFactoryDef = function MatAccordion_Factory(t) { return ɵMatAccordion_BaseFactory(t || MatAccordion); };
MatAccordion.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatAccordion, selectors: [["mat-accordion"]], contentQueries: function MatAccordion_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
